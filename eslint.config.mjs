...
const MAX_LINES_ALLOWLIST = {
  ...
  'web/src/components/HygienePanel.tsx': 300, // 現在 252 (bdboard-sso1.11 PR-C: useHygieneRepairActions フックへ移動)
  'web/src/components/hygiene/useHygieneRepairActions.ts': 350, // 現在 307 (bdboard-sso1.11 PR-C: repair/mutation ハンドラをカスタムフックへ抽出)
