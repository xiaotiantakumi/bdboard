...
const MAX_LINES_ALLOWLIST = {
  ...
  'web/src/components/ChatPanel.tsx': 1720, // 現在 1710 (ESLint実測。bdboard-sso1.83 第10段: 会話キーの導出とスレッド一覧の操作を chat/useConversationKey.ts / chat/useChatThreadLists.ts へ抽出)
