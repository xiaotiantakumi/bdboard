...
const MAX_LINES_ALLOWLIST = {
  ...
  'web/src/components/ChatPanel.tsx': 1856, // 現在 1846 (ESLint実測。bdboard-sso1.83 第8段: スクロール追従を chat/useStickToBottomScroll.ts へ、経過秒数表示を chat/useElapsedSeconds.ts へ抽出)
