...
const MAX_LINES_ALLOWLIST = {
  ...
  'web/src/components/ChatPanel.tsx': 1788, // 現在 1778 (ESLint実測。bdboard-sso1.83 第9段: エージェント・モデル選択を chat/useChatAgentModelState.ts / chat/useAgentFromConversationSync.ts / chat/useAgentListAndModelRestore.ts へ抽出)
