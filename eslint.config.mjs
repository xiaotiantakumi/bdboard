...
const MAX_LINES_ALLOWLIST = {
  ...
  'web/src/components/ChatPanel.tsx': 1148, // 現在 1138 (ESLint実測。bdboard-sso1.83 第13b段: 送信本体を chat/useChatSubmit.ts / chat/deliverChatSend.ts / chat/sendRequest.ts / chat/useChatSendCommits.ts へ抽出)
