...
const MAX_LINES_ALLOWLIST = {
  ...
  'web/src/components/ChatPanel.tsx': 1630, // 現在 1620 (ESLint実測。bdboard-sso1.83 第11段: 会話ストアと履歴ローダーを chat/useChatConversationsState.ts / chat/useChatHistoryLoader.ts へ抽出)
