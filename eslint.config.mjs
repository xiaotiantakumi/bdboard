...
const MAX_LINES_ALLOWLIST = {
  ...
  'web/src/components/bulk-action/useBulkActions.ts': 230, // 現在 222 (bdboard-sso1.60: 一括クイックアクション/一括ラベル付与の mutation を ./actions/*.ts へ分割。280→222。move-only 抽出のため引き続き例外的にここへ追加)
