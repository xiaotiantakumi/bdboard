...
function makeProps(
  ...
  return {
    ...
    onOpenTicket: vi.fn(),
    dependencies: {
      dependencyMutationPending: true,
    ...
    sessionLink: {
      sessionLinkPickerOpen: true,
      togglePicker: vi.fn(),
      isLoadingSessions: true,
      activeSessionCandidates: [],
      sessionLinkMutationPending: true,
    ...
    quickActions: {
      ...
      deferSubmitDisabled: true,
      handleDeferQuickAction: vi.fn(),
      canRaisePriority: true,
      canLowerPriority: true,
      quickActionConfirmRef: { current: null },
      cancelQuickActionRef: { current: null },
    ...
    agentRun: {
      ...
      selectedHistoryRunLoading: true,
